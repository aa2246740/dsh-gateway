window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region ../../runtime/packages/util/brand/lib/index.js
		/**
		...
		*/
		...
		//#endregion
		//#region ../../runtime/packages/core/session/lib/types/types.js
		/**
		...
		*/
		...
		//#endregion
		//#region \0dshx-css-module:/Users/wu/Documents/DeepSeekHarness/plugins/dsh-messaging-gateway/src/client/MessagingSection.module.css.mjs
		const css$1 = "._7nL8Kq_root{flex-direction:column;flex:none;width:100%;min-width:0;padding:4px 0 0;display:flex}._7nL8Kq_header{width:100%;color:var(--dsw-alias-label-tertiary);font:inherit;letter-spacing:.02em;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;align-items:center;gap:4px;margin:0;padding:6px 8px;font-size:12px;font-weight:500;display:flex}._7nL8Kq_header:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._7nL8Kq_mark{background:var(--dsw-alias-interactive-bg-hover);width:16px;height:16px;color:var(--dsw-alias-label-primary);letter-spacing:0;text-transform:none;border-radius:4px;flex:none;justify-content:center;align-items:center;font-size:9px;font-weight:600;display:inline-flex}._7nL8Kq_rows{flex-direction:column;max-height:9.5rem;padding:0 0 4px;display:flex;overflow-y:auto}._7nL8Kq_row{width:100%;color:var(--dsw-alias-label-primary);font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;flex-direction:column;margin:0;padding:6px 8px 6px 28px;font-size:13px;line-height:18px;display:flex}._7nL8Kq_cwd{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:15px;overflow:hidden}._7nL8Kq_row:hover{background:var(--dsw-alias-interactive-bg-hover)}._7nL8Kq_empty{color:var(--dsw-alias-label-tertiary);padding:6px 8px 6px 28px;font-size:12px;line-height:18px}._7nL8Kq_rail{width:36px;padding:0}._7nL8Kq_rail ._7nL8Kq_header{text-transform:none;border-radius:50%;justify-content:center;width:36px;height:36px;padding:0}._7nL8Kq_rail ._7nL8Kq_rows{display:none}";
		...
		//#endregion
		//#region \0dshx-css-module:/Users/wu/Documents/DeepSeekHarness/plugins/dsh-messaging-gateway/src/client/SettingsPage.module.css.mjs
		const css = ".UQdeEq_page{max-width:640px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:8px;display:flex}.UQdeEq_heading{margin:0;font-size:18px;font-weight:600;line-height:26px}.UQdeEq_intro{color:var(--dsw-alias-label-tertiary);margin:0 0 8px;font-size:13px;line-height:1.5}.UQdeEq_status{flex-wrap:wrap;gap:8px;padding:4px 0 8px;display:flex}.UQdeEq_badge{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;align-items:center;gap:6px;padding:3px 10px;font-size:12px;font-weight:500;line-height:18px;display:inline-flex}.UQdeEq_dot{background:var(--dsw-alias-label-tertiary);border-radius:50%;width:6px;height:6px}.UQdeEq_dotOn{background:var(--dsw-alias-state-success,#3d9a5f)}.UQdeEq_block{border-bottom:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;padding:16px 0;display:flex}.UQdeEq_block:last-child{border-bottom:none}.UQdeEq_blockTitle{margin:0;font-size:14px;font-weight:500;line-height:22px}.UQdeEq_blockHint{color:var(--dsw-alias-label-tertiary);margin:0 0 8px;font-size:13px;line-height:1.5}.UQdeEq_howto{border:0;margin:0 0 8px}.UQdeEq_howto summary{cursor:pointer;color:var(--dsw-alias-label-secondary);font-size:13px;line-height:22px;list-style:none}.UQdeEq_howto summary::-webkit-details-marker{display:none}.UQdeEq_howto summary:hover{color:var(--dsw-alias-label-primary)}.UQdeEq_steps{color:var(--dsw-alias-label-secondary);gap:6px;margin:8px 0 0;padding-left:18px;font-size:13px;line-height:1.5;display:grid}.UQdeEq_steps a{color:var(--dsw-alias-label-primary)}.UQdeEq_field{flex-direction:column;gap:6px;padding:12px 0 0;display:flex}.UQdeEq_label{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:500;line-height:1.5}.UQdeEq_input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}.UQdeEq_input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}.UQdeEq_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}.UQdeEq_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}.UQdeEq_actions{justify-content:flex-end;align-items:center;gap:8px;padding:16px 0 4px;display:flex}.UQdeEq_ghost,.UQdeEq_primary{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.UQdeEq_ghost{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.UQdeEq_ghost:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}.UQdeEq_primary{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}.UQdeEq_ghost:disabled,.UQdeEq_primary:disabled{opacity:.4;cursor:default}.UQdeEq_ghost:focus-visible,.UQdeEq_primary:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:2px}.UQdeEq_note{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}.UQdeEq_warn{color:var(--dsw-alias-label-tertiary);margin:8px 0 0;font-size:13px;line-height:1.5}";
		...
		var SettingsPage_module_css_default = {
			"actions": "UQdeEq_actions",
			"badge": "UQdeEq_badge",
			"block": "UQdeEq_block",
			"blockHint": "UQdeEq_blockHint",
			"blockTitle": "UQdeEq_blockTitle",
			"dot": "UQdeEq_dot",
			"dotOn": "UQdeEq_dotOn",
			"field": "UQdeEq_field",
			"ghost": "UQdeEq_ghost",
			"heading": "UQdeEq_heading",
			"hint": "UQdeEq_hint",
			"howto": "UQdeEq_howto",
			"input": "UQdeEq_input",
			"intro": "UQdeEq_intro",
			...
			"note": "UQdeEq_note",
			"page": "UQdeEq_page",
			"primary": "UQdeEq_primary",
			"status": "UQdeEq_status",
			"steps": "UQdeEq_steps",
			"warn": "UQdeEq_warn"
		};
		//#endregion
