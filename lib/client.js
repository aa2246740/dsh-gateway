window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dshx-css-module:/Users/wu/Documents/Codex/2026-08-15/bang/deepseek-harness-rc8/my-plugins/dsh-messaging-gateway/src/client/MessagingSection.module.css.mjs
		const css$1 = ".qxuVzG_root{flex-direction:column;flex:none;width:100%;min-width:0;padding:4px 0 0;display:flex}.qxuVzG_header{width:100%;color:var(--dsw-alias-label-tertiary);font:inherit;letter-spacing:.02em;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;align-items:center;gap:4px;margin:0;padding:6px 8px;font-size:12px;font-weight:500;display:flex}.qxuVzG_header:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.qxuVzG_mark{background:var(--dsw-alias-interactive-bg-hover);width:16px;height:16px;color:var(--dsw-alias-label-primary);letter-spacing:0;text-transform:none;border-radius:4px;flex:none;justify-content:center;align-items:center;font-size:9px;font-weight:600;display:inline-flex}.qxuVzG_rows{flex-direction:column;max-height:9.5rem;padding:0 0 4px;display:flex;overflow-y:auto}.qxuVzG_row{width:100%;color:var(--dsw-alias-label-primary);font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;margin:0;padding:6px 8px 6px 28px;font-size:13px;line-height:18px;display:block}.qxuVzG_row:hover{background:var(--dsw-alias-interactive-bg-hover)}.qxuVzG_empty{color:var(--dsw-alias-label-tertiary);padding:6px 8px 6px 28px;font-size:12px;line-height:18px}.qxuVzG_rail{width:36px;padding:0}.qxuVzG_rail .qxuVzG_header{text-transform:none;border-radius:50%;justify-content:center;width:36px;height:36px;padding:0}.qxuVzG_rail .qxuVzG_rows{display:none}";
		...
		//#endregion
		//#region \0dshx-css-module:/Users/wu/Documents/Codex/2026-08-15/bang/deepseek-harness-rc8/my-plugins/dsh-messaging-gateway/src/client/SettingsPage.module.css.mjs
		const css = ".WeAYMq_page{max-width:640px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:8px;display:flex}.WeAYMq_heading{margin:0;font-size:18px;font-weight:600;line-height:26px}.WeAYMq_intro{color:var(--dsw-alias-label-tertiary);margin:0 0 8px;font-size:13px;line-height:1.5}.WeAYMq_status{flex-wrap:wrap;gap:8px;padding:4px 0 8px;display:flex}.WeAYMq_badge{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;align-items:center;gap:6px;padding:3px 10px;font-size:12px;font-weight:500;line-height:18px;display:inline-flex}.WeAYMq_dot{background:var(--dsw-alias-label-tertiary);border-radius:50%;width:6px;height:6px}.WeAYMq_dotOn{background:var(--dsw-alias-state-success,#3d9a5f)}.WeAYMq_block{border-bottom:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;padding:16px 0;display:flex}.WeAYMq_block:last-child{border-bottom:none}.WeAYMq_blockTitle{margin:0;font-size:14px;font-weight:500;line-height:22px}.WeAYMq_blockHint{color:var(--dsw-alias-label-tertiary);margin:0 0 8px;font-size:13px;line-height:1.5}.WeAYMq_howto{border:0;margin:0 0 8px}.WeAYMq_howto summary{cursor:pointer;color:var(--dsw-alias-label-secondary);font-size:13px;line-height:22px;list-style:none}.WeAYMq_howto summary::-webkit-details-marker{display:none}.WeAYMq_howto summary:hover{color:var(--dsw-alias-label-primary)}.WeAYMq_steps{color:var(--dsw-alias-label-secondary);gap:6px;margin:8px 0 0;padding-left:18px;font-size:13px;line-height:1.5;display:grid}.WeAYMq_steps a{color:var(--dsw-alias-label-primary)}.WeAYMq_field{flex-direction:column;gap:6px;padding:12px 0 0;display:flex}.WeAYMq_label{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:500;line-height:1.5}.WeAYMq_input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}.WeAYMq_input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}.WeAYMq_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}.WeAYMq_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}.WeAYMq_actions{justify-content:flex-end;align-items:center;gap:8px;padding:16px 0 4px;display:flex}.WeAYMq_ghost,.WeAYMq_primary{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.WeAYMq_ghost{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.WeAYMq_ghost:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}.WeAYMq_primary{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}.WeAYMq_ghost:disabled,.WeAYMq_primary:disabled{opacity:.4;cursor:default}.WeAYMq_ghost:focus-visible,.WeAYMq_primary:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:2px}.WeAYMq_note{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}.WeAYMq_warn{color:var(--dsw-alias-label-tertiary);margin:8px 0 0;font-size:13px;line-height:1.5}";
		...
		var SettingsPage_module_css_default = {
			"actions": "WeAYMq_actions",
			"badge": "WeAYMq_badge",
			"block": "WeAYMq_block",
			"blockHint": "WeAYMq_blockHint",
			"blockTitle": "WeAYMq_blockTitle",
			"dot": "WeAYMq_dot",
			"dotOn": "WeAYMq_dotOn",
			"field": "WeAYMq_field",
			"ghost": "WeAYMq_ghost",
			"heading": "WeAYMq_heading",
			"hint": "WeAYMq_hint",
			"howto": "WeAYMq_howto",
			"input": "WeAYMq_input",
			"intro": "WeAYMq_intro",
			...
			"note": "WeAYMq_note",
			"page": "WeAYMq_page",
			"primary": "WeAYMq_primary",
			"status": "WeAYMq_status",
			"steps": "WeAYMq_steps",
			"warn": "WeAYMq_warn"
		};
		//#endregion
