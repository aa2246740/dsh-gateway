window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/@deepseek-ai+dsh-session@0.1.7-rc.1_@deepseek-ai+cordis@4.0.4_@deepseek-ai+dsh-scope@0._d0632e5334fc6fa9e0d505304507fe7f/node_modules/@deepseek-ai/dsh-session/lib/types/types.js
		/**
		...
		*/
		...
		//#endregion
		//#region \0dshx-css-module:/agent/repos/dsh-gateway/src/client/MessagingSection.module.css.mjs
		const css$1 = ".xHlBdG_root{flex-direction:column;flex:none;width:100%;min-width:0;padding:4px 0 0;display:flex}.xHlBdG_header{width:100%;color:var(--dsw-alias-label-tertiary);font:inherit;letter-spacing:.02em;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;align-items:center;gap:4px;margin:0;padding:6px 8px;font-size:12px;font-weight:500;display:flex}.xHlBdG_header:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.xHlBdG_mark{background:var(--dsw-alias-interactive-bg-hover);width:16px;height:16px;color:var(--dsw-alias-label-primary);letter-spacing:0;text-transform:none;border-radius:4px;flex:none;justify-content:center;align-items:center;font-size:9px;font-weight:600;display:inline-flex}.xHlBdG_rows{flex-direction:column;max-height:9.5rem;padding:0 0 4px;display:flex;overflow-y:auto}.xHlBdG_row{width:100%;color:var(--dsw-alias-label-primary);font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;flex-direction:column;margin:0;padding:6px 8px 6px 28px;font-size:13px;line-height:18px;display:flex}.xHlBdG_cwd{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:15px;overflow:hidden}.xHlBdG_row:hover{background:var(--dsw-alias-interactive-bg-hover)}.xHlBdG_empty{color:var(--dsw-alias-label-tertiary);padding:6px 8px 6px 28px;font-size:12px;line-height:18px}.xHlBdG_rail{width:36px;padding:0}.xHlBdG_rail .xHlBdG_header{text-transform:none;border-radius:50%;justify-content:center;width:36px;height:36px;padding:0}.xHlBdG_rail .xHlBdG_rows{display:none}";
				...
				children: groups.map((group) => {
					...
					return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
						...
						children: group.rows.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [row.title, row.turn === "inFlight" ? " …" : ""] }), row.cwd ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: MessagingSection_module_css_default.cwd,
								title: row.cwd,
								children: row.cwd
							}) : null]
						}, row.sessionKey))
		...
		//#endregion
		//#region \0dshx-css-module:/agent/repos/dsh-gateway/src/client/SettingsPage.module.css.mjs
		const css = ".Wq0XEG_page{max-width:640px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:8px;display:flex}.Wq0XEG_heading{margin:0;font-size:18px;font-weight:600;line-height:26px}.Wq0XEG_intro{color:var(--dsw-alias-label-tertiary);margin:0 0 8px;font-size:13px;line-height:1.5}.Wq0XEG_status{flex-wrap:wrap;gap:8px;padding:4px 0 8px;display:flex}.Wq0XEG_badge{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;align-items:center;gap:6px;padding:3px 10px;font-size:12px;font-weight:500;line-height:18px;display:inline-flex}.Wq0XEG_dot{background:var(--dsw-alias-label-tertiary);border-radius:50%;width:6px;height:6px}.Wq0XEG_dotOn{background:var(--dsw-alias-state-success,#3d9a5f)}.Wq0XEG_block{border-bottom:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;padding:16px 0;display:flex}.Wq0XEG_block:last-child{border-bottom:none}.Wq0XEG_blockTitle{margin:0;font-size:14px;font-weight:500;line-height:22px}.Wq0XEG_blockHint{color:var(--dsw-alias-label-tertiary);margin:0 0 8px;font-size:13px;line-height:1.5}.Wq0XEG_howto{border:0;margin:0 0 8px}.Wq0XEG_howto summary{cursor:pointer;color:var(--dsw-alias-label-secondary);font-size:13px;line-height:22px;list-style:none}.Wq0XEG_howto summary::-webkit-details-marker{display:none}.Wq0XEG_howto summary:hover{color:var(--dsw-alias-label-primary)}.Wq0XEG_steps{color:var(--dsw-alias-label-secondary);gap:6px;margin:8px 0 0;padding-left:18px;font-size:13px;line-height:1.5;display:grid}.Wq0XEG_steps a{color:var(--dsw-alias-label-primary)}.Wq0XEG_field{flex-direction:column;gap:6px;padding:12px 0 0;display:flex}.Wq0XEG_label{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:500;line-height:1.5}.Wq0XEG_input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}.Wq0XEG_input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}.Wq0XEG_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}.Wq0XEG_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}.Wq0XEG_actions{justify-content:flex-end;align-items:center;gap:8px;padding:16px 0 4px;display:flex}.Wq0XEG_ghost,.Wq0XEG_primary{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.Wq0XEG_ghost{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.Wq0XEG_ghost:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}.Wq0XEG_primary{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}.Wq0XEG_ghost:disabled,.Wq0XEG_primary:disabled{opacity:.4;cursor:default}.Wq0XEG_ghost:focus-visible,.Wq0XEG_primary:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:2px}.Wq0XEG_note{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}.Wq0XEG_warn{color:var(--dsw-alias-label-tertiary);margin:8px 0 0;font-size:13px;line-height:1.5}";
		...
		var SettingsPage_module_css_default = {
			"actions": "Wq0XEG_actions",
			"badge": "Wq0XEG_badge",
			"block": "Wq0XEG_block",
			"blockHint": "Wq0XEG_blockHint",
			"blockTitle": "Wq0XEG_blockTitle",
			"dot": "Wq0XEG_dot",
			"dotOn": "Wq0XEG_dotOn",
			"field": "Wq0XEG_field",
			"ghost": "Wq0XEG_ghost",
			"heading": "Wq0XEG_heading",
			"hint": "Wq0XEG_hint",
			"howto": "Wq0XEG_howto",
			"input": "Wq0XEG_input",
			"intro": "Wq0XEG_intro",
			...
			"note": "Wq0XEG_note",
			"page": "Wq0XEG_page",
			"primary": "Wq0XEG_primary",
			"status": "Wq0XEG_status",
			"steps": "Wq0XEG_steps",
			"warn": "Wq0XEG_warn"
		};
		//#endregion
		...
		function MessagingSettings(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LoadedPage, {
				scope: props.scope,
				loadModelCatalog: props.loadModelCatalog
			});
		}
		function LoadedPage({ scope, loadModelCatalog }) {
			...
			const [slackWorkspace, setSlackWorkspace] = (0, react.useState)();
			const [slackModel, setSlackModel] = (0, react.useState)();
			const [slackEffort, setSlackEffort] = (0, react.useState)();
			...
			const [feishuWorkspace, setFeishuWorkspace] = (0, react.useState)();
			const [feishuModel, setFeishuModel] = (0, react.useState)();
			const [feishuEffort, setFeishuEffort] = (0, react.useState)();
			const [saveMessage, setSaveMessage] = (0, react.useState)("");
			const [models, setModels] = (0, react.useState)();
			const [modelError, setModelError] = (0, react.useState)();
			...
			const slackDirty = owner.length > 0 || bot.length > 0 || app.length > 0 || slackWorkspace !== void 0 || slackModel !== void 0 || slackEffort !== void 0;
			const feishuDirty = feishuOwner.length > 0 || feishuAppId.length > 0 || feishuSecret.length > 0 || feishuWorkspace !== void 0 || feishuModel !== void 0 || feishuEffort !== void 0;
			...
			const save = (patch, reset) => {
				...
				scope.mutate(ops).then((accepted) => {
					if (!accepted) {
				...
				}).catch((error) => setSaveMessage(`保存失败：${error instanceof Error ? error.message : String(error)}`)).finally(() => setWriting(false));
			};
			...
			const effortField = (platform, route, value, setValue) => {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
							...
							"data-mgw": `field-${platform}-effort`,
							value,
							disabled: !route || !reasoning?.efforts.length,
							onChange: (event) => setValue(event.target.value),
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: "",
									children: !route ? "跟随 Host 默认模型及推理强度" : `模型默认${reasoning?.defaultEffort ? ` · ${reasoning.defaultEffort}` : ""}`
								}),
								value && !reasoning?.efforts.some((effort) => effort.id === value) ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("option", {
									value,
									children: [value, "（当前保留）"]
								}) : null,
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							children: "由所选模型提供可用档位。切换模型会重置为该模型默认强度。"
						})
					]
				});
			};
			const openModelsSettings = () => {
				const modelsButton = Array.from(document.querySelectorAll("nav button")).find((button) => ["模型", "Models"].includes(button.textContent?.trim() ?? ""));
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					modelError ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
						role: "alert",
						children: ["模型目录读取失败：", modelError]
					}) : null,
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: SettingsPage_module_css_default.hint,
										children: "你自己的 U…，不是 bot 的。只有在本机设置保存它才会确认 Owner；陌生私信不会自动绑定。"
									})
								]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: SettingsPage_module_css_default.hint,
										children: "必须是绝对路径。默认与飞书隔离；两边填同一路径才会显式共享。已有会话不会迁移。"
									})
								]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
										...
										onChange: (event) => {
											setSlackModel(event.target.value);
											setSlackEffort("");
										},
										children: [
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("option", {
												value: "",
												children: ["跟随 Host 默认", models?.default ? ` · ${models.default.provider}/${models.default.model}` : ""]
											}),
											settings.slackModel && !modelOptions.some((option) => option.value === settings.slackModel) ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("option", {
												value: settings.slackModel,
												children: [settings.slackModel, "（当前保留）"]
											}) : null,
											modelOptions.map((option) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
												value: option.value,
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									...
									onClick: () => {
										...
										if (slackWorkspace !== void 0) patch.slackWorkspaceDir = slackWorkspace;
										if (slackModel !== void 0) patch.slackModel = slackModel;
										if (slackEffort !== void 0) patch.slackReasoningEffort = slackEffort;
										...
										save(patch, () => {
											...
											setBot("");
											setApp("");
											setSlackWorkspace(void 0);
											setSlackModel(void 0);
											setSlackEffort(void 0);
										});
									},
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: SettingsPage_module_css_default.hint,
										children: "你自己的 ou_…，不是机器人的。只有在本机设置保存它才会确认 Owner。"
									})
								]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: SettingsPage_module_css_default.hint,
										children: "必须是绝对路径。默认与 Slack 隔离；显式填写同一路径可共享。已有会话 cwd 保持不变。"
									})
								]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
										...
										onChange: (event) => {
											setFeishuModel(event.target.value);
											setFeishuEffort("");
										},
										children: [
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("option", {
											...
											settings.feishuModel && !modelOptions.some((option) => option.value === settings.feishuModel) ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("option", {
												value: settings.feishuModel,
												children: [settings.feishuModel, "（当前保留）"]
											}) : null,
											modelOptions.map((option) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
												value: option.value,
												children: option.label
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: SettingsPage_module_css_default.hint,
										children: "模型来自当前 Host 的实际目录，不手填未知路由。"
									})
								]
							}),
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									...
									onClick: () => {
										...
										if (feishuWorkspace !== void 0) patch.feishuWorkspaceDir = feishuWorkspace;
										if (feishuModel !== void 0) patch.feishuModel = feishuModel;
										if (feishuEffort !== void 0) patch.feishuReasoningEffort = feishuEffort;
										...
										save(patch, () => {
											...
											setFeishuAppId("");
											setFeishuSecret("");
											setFeishuWorkspace(void 0);
											setFeishuModel(void 0);
											setFeishuEffort(void 0);
										});
									},
									children: saveActionLabel({
										bound: feishu.bound,
		...
		function sessionsFace(ctx) {
			return {
				open: (id) => {
					ctx.uiWorkspace.openSession(SessionId(id));
				},
